...
const url_1 = __importDefault(require("../../src/domain/url"));
describe("url util", () => {
    it("should parse the passed URL", () => {
        let parsedURL = url_1.default.parse('http://www.google.com/thePath?param1=value1&amp;param2=value2&amp;param3=value3');
    ...
    it("should handle urls with double slashes correctly", () => {
        let parsedURL = url_1.default.parse('http://www.google.com0//thePath//test1/test2?param1=value1&amp;param2=value2');
